...
/**
 * Combined schema: 14 common properties + 5 economics-specific.
 *
 * Rules enforced:
...
export const schema = {
  ...
  properties: [
...

    {
      ...
      isRetrievable: true,
      isRefinable: true,
      aliases: ["economicMetric", "econIndicator"],
    },
    {
      name: "gdpValue",
      type: "Double",
    ...
    },
    {
      ...
      isRetrievable: true,
      isRefinable: true,
      aliases: ["incomeLevel", "wealthGroup"],
    },
    {
      ...
      isRetrievable: true,
      isRefinable: true,
      aliases: ["devCategory", "hdiCategory"],
    },
