...
/**
 * Combined schema: 14 common properties + 5 agriculture-specific.
 *
 * Rules enforced:
...
export const schema = {
  ...
  properties: [
    ...
    // ── Agriculture-specific properties ──

    {
      name: "cropOrCommodity",
      type: "String",
      isQueryable: true,
      isRetrievable: true,
      isRefinable: true,
      aliases: ["crop", "commodity", "product"],
    },
    {
      name: "foodSecurityPhase",
      type: "String",
      isQueryable: true,
      isRetrievable: true,
      isRefinable: true,
      aliases: ["ipcPhase", "hungerPhase"],
    },
    {
    ...
    },
    {
      ...
      isRetrievable: true,
      isRefinable: true,
      aliases: ["trade", "importExport"],
    },
    {
      name: "agriculturalDomain",
      type: "String",
      isQueryable: true,
      isRetrievable: true,
      isRefinable: true,
      aliases: ["domain", "sector"],
    },
