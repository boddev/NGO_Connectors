...
/**
 * Combined schema: 14 common properties + 5 refugee-specific.
 *
 * Rules enforced:
...
export const schema = {
  ...
  properties: [
...

    {
      ...
      isRetrievable: true,
      isRefinable: true,
      aliases: ["displacement", "populationType"],
    },
    {
    ...
    },
    {
      ...
      isRetrievable: true,
      isRefinable: true,
      aliases: ["origin", "sourceCountry"],
    },
    {
      name: "countryOfAsylum",
      type: "String",
      isQueryable: true,
      isRetrievable: true,
      isRefinable: true,
      aliases: ["asylum", "hostCountry"],
    },
    {
