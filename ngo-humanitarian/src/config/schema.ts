...
/**
 * Combined schema: 14 common properties + 5 humanitarian-specific.
 *
 * Rules enforced:
...
export const schema = {
  ...
  properties: [
    ...
    // ── Humanitarian-specific properties ──

    {
      ...
      isRetrievable: true,
      isRefinable: true,
      aliases: ["disaster", "emergency", "hazard"],
    },
    {
    ...
    },
    {
      ...
      isRetrievable: true,
      isRefinable: true,
      aliases: ["responder", "agency"],
    },
    {
      name: "humanitarianSector",
      type: "String",
      isQueryable: true,
      isRetrievable: true,
      isRefinable: true,
      aliases: ["cluster", "sector"],
    },
