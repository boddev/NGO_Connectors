...
/**
 * Combined schema: 14 common properties + 5 multi-sector-specific.
 *
 * Rules enforced:
...
export const schema = {
  ...
  properties: [
    ...
    // ── Multi-sector-specific properties ──

    {
      ...
      isRetrievable: true,
      isRefinable: true,
      aliases: ["sdg", "sustainableDevelopmentGoal"],
    },
    {
      name: "sdgTarget",
      type: "String",
