...
import type { EducationRecord } from "../dataSources/types.js";

const crawlQueueOutput = output.storageQueue({
  queueName: "ngo-education-crawl-requests",
...
async function executeFullCrawl(
  ...
  // Source 1: World Bank
  context.log("Fetching World Bank education data...");
  try {
  ...
  context.log("Fetching Our World in Data education datasets...");
  try {
