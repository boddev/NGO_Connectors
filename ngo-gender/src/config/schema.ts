...
/**
 * Combined schema: 14 common properties + 5 gender-specific.
 *
 * Rules enforced:
...
export const schema = {
  ...
  properties: [
    ...
    // ── Gender-specific properties ──

    {
      name: "genderIndicator",
      type: "String",
      isQueryable: true,
      isRetrievable: true,
      isRefinable: true,
      aliases: ["genderMetric"],
    },
    {
      name: "genderParityIndex",
      type: "Double",
      isQueryable: true,
      isRetrievable: true,
    },
